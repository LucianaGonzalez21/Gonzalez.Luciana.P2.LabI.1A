...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    if(this != NULL && this2 != NULL)
    {
    	...
    	for(int i=0; i<tam; i++)
    	{
    		if(!ll_contains(this, ll_get(this2, i)))	//en vez de buscar que esten todos, me fijo si alguno no esta
    		{
    			returnAux=0;
    			break;
    		}
...
/// @brief Filtra los elementos del Linked List
///
/// @param this
/// @param pFunc Puntero a la funcion filtrante
/// @return Retorna un linked list nuevo con los elementos que pasen el filtrado
/// 		o NULL en el caso de error de parametros
	...
	if(this!=NULL && pFunc!=NULL)
	{
		...
		if(filterList!=NULL)
		{
			...
			for(int i=0; i<tam; i++)
			{
				...
				if(pFunc(pElement))	//le pregunto a pFunc si el elemento lo tengo que agregar a filterList . si retorna 1 lo agrego
				{
